define(['jquery', 'angular', 'moment', 'PNotify', 'jquery-mousewheel', 'datatables.net'], function (jquery, angular, moment, PNotify, jqueryMousewheel, datatables) {
    'use strict';
    console.log(angular);
    ...
    var app = angular.module('bluetech', []);
